...
public class Apprenant {
        ...
        public int getDate_de_nessance() {
                return date_de_nessance;
        }
        ...
        public void setDate_de_nessance(int date_de_nessance) {
                this.date_de_nessance = date_de_nessance;
        }
        ...
        public void Ajouter(ArrayList<Apprenant> apprenants){
                ...
                A.date_de_nessance = scanner.nextInt();
        ...
        public void Consulter(ArrayList<Apprenant> apprenants){
                ...
                System.out.println("la date de naissance :" +date_de_nessance);
